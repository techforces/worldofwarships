...
const VehicleItem = ({ data, index, setItemIndex }: VehicleItemProps) => {
  ...
  return (
    <div
      ...
      className="vehicle-item relative w-full aspect-[4/3] bg-[rgba(4,18,40,0.25)] backdrop-blur-[8px] px-8 flex items-end"
    >
      ...
      <div className={`w-full h-max overflow-hidden py-8`}>
        <div
